...
#ifndef __INET_MANETGENERALSERIALIZER_H
#define __INET_MANETGENERALSERIALIZER_H
 ...
 */
class INET_API ManetGeneralSerializer : public SerializerBase
{
  protected:
  ...
  public:
    ManetGeneralSerializer(const char *name = nullptr) : SerializerBase(name) {}
};
